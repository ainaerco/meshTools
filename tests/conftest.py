...
_candidates = [
    ...
    _build_dir / "bindings" / "chull" / "Debug",
    _build_dir / "bindings" / "chull" / "Release",
    _build_dir / "bindings" / "chull",
    _build_dir / "bindings" / "delaunay" / "Debug",
    _build_dir / "bindings" / "delaunay" / "Release",
    _build_dir / "bindings" / "delaunay",
    _build_dir / "bindings" / "noise" / "Debug",
    _build_dir / "bindings" / "noise" / "Release",
    _build_dir / "bindings" / "noise",
